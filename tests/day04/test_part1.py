...
def test_2():
    assert d04p1.get_lucky_numbers("41 48 83 86 17 | 83 86  6 31 17  9 48 53") == {'48', '83', '17', '86'}
    assert d04p1.get_lucky_numbers("13 32 20 16 61 | 61 30 68 82 17 32 24 19") == {'32', '61'}
    assert d04p1.get_lucky_numbers("1 21 53 59 44 | 69 82 63 72 16 21 14  1") == {'1', '21'}
